...
// Benchmarks from docs/plans/map-engine-rewrite.md §5. Scenarios run serially —
...
test.describe("map update benchmarks", () => {
    ...
    const scenarios: StressScenario[] = [
        ...
        // pre-rewrite baselines (412 ms ticks at 2 000 entities) are recorded in
        // docs/plans/map-engine-rewrite.md §5.1.
        {
