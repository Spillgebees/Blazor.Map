...
{
    [Test]
    public void Should_inherit_source_layer_group_metadata_when_layer_does_not_override_it()
    {
        // arrange
        ...
        registration.LayerGroup.Should().Be("stations");
        registration.BeforeLayerGroup.Should().BeNull();
        registration.AfterLayerGroup.Should().Be("trains");
    }

    [Test]
    public void Should_prefer_explicit_layer_group_metadata_over_inherited_source_values()
    {
        // arrange
        ...
        // assert
        registration.LayerGroup.Should().Be("labels");
        registration.BeforeLayerGroup.Should().Be("base");
        registration.AfterLayerGroup.Should().Be("trains");
    }
}
